...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    progressListArray = ['Work on projects', "Listen to Qur'an"];
...
function createItemEl(columnEl, column, item, index) {
  ...
  listEl.id = index;
  listEl.setAttribute('onfocus', `updateItem(${index},${column})`);
  //Apending
...
//Adding To Column list and ResetT TextBox
...
//Column Allows For Element to drop;
